...
export default function OrderDetailPage() {
  ...
  if (!order) {
    return <div className="text-center py-16 text-gray-500">Sipariş bulunamadı</div>;
  }
    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-4">
          ...
          >
            <Download className="h-4 w-4" /> Proforma İndir
          </a>
        </div>
      </div>
      ...
      {order.rejectionReason && (
        <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
          <p className="text-sm font-medium text-red-700">Red Sebebi:</p>
      ...
      {order.trackingNumber && (
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
          <p className="text-sm font-medium text-blue-700">Kargo Bilgisi:</p>
      ...
      {order.dueDate && (
        <div className="mt-4 bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <p className="text-sm text-gray-500">{formatDate(order.dueDate)}</p>
        </div>
      )}
    </div>
  );
